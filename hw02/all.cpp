...
int main(){
    ...
    while (1) {
        ...
        if(!isAllOnTable(my, cus_max, item_list) && my.isItemExist("DISH")){
            printf("USE %d %d\n", kitchen.getTable_X(my.getX(), my.getY(), item_list), kitchen.getTable_Y(my.getX(), my.getY(), item_list));
            continue;
        }
        ...
        // if(cus_max.isItemExist("BLUEBERRIES")){
        //     if(!item_list.isItemExist("BLUEBERRIES")){
        //         if(!my.isItemExist("BLUEBERRIES")){
        //             if(item_list.isItemExist("BLUEBERRIES")){
        //                 Item bberry = item_list.getItem("BLUEBERRIES");
        //                 printf("USE %d %d\n", bberry.getX(), bberry.getY());
        //             }
        //             else{
        //                 printf("USE %d %d\n", kitchen.getEquip_X(BLUEBERRIES), kitchen.getEquip_Y(BLUEBERRIES));
        //             }
        ...
        //     }
        // }
        // if(cus_max.isItemExist("ICE_CREAM")){
        //     if(!item_list.isItemExist("ICE_CREAM")){
        //         if(!my.isItemExist("ICE_CREAM")){
        //             if(item_list.isItemExist("ICE_CREAM")){
        //                 Item ice = item_list.getItem("ICE_CREAM");
        //                 printf("USE %d %d\n", ice.getX(), ice.getY());
        //             }
        //             else{
